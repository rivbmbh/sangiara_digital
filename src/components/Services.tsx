...
import { Layout, ShoppingBag, Cpu, RefreshCw, TrendingUp, CheckCircle, Flame, ArrowUpRight } from "lucide-react";
...
export default function Services() {
  ...
  return (
    <section id="layanan" className="pt-48 sm:pt-72 md:pt-96 pb-24 bg-slate-50/70 relative z-0">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <ScrollReveal delayMs={100}>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Solusi Digital Lengkap Berstandar <span className="gradient-fire-text">Internasional</span>
            </h2>
          </ScrollReveal>

          <ScrollReveal delayMs={200}>
            <p className="text-slate-600 text-base sm:text-lg">
              Setiap proyek dikembangkan secara khusus sesuai identitas brand Anda untuk memaksimalkan hasil bisnis.
            </p>
          </ScrollReveal>
        </div>
                ...
                <div className="group relative bg-white p-8 rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-fire-sm hover:border-red-300 transition-all duration-300 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform`}>
