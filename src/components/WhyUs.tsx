...
import { Zap, Palette, Search, Smartphone, ShieldCheck, HeartHandshake, Flame, CheckCircle2 } from "lucide-react";
...
export default function WhyUs() {
  ...
  return (
    <section id="keunggulan" className="py-24 bg-slate-50/60 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <ScrollReveal delayMs={100}>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Alasan SANGIARA DIGITAL Menjadi <span className="gradient-fire-text">Pilihan Utama</span>
            </h2>
          </ScrollReveal>

          <ScrollReveal delayMs={200}>
            <p className="text-slate-600 text-base sm:text-lg">
              Kami tidak hanya membuat website indah, tetapi membangun aset digital yang memajukan omset bisnis Anda.
            </p>
          </ScrollReveal>
        </div>
          ...
          <div className="p-8 sm:p-12 rounded-3xl gradient-fire-bg text-white shadow-fire-lg relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y lg:divide-y-0 lg:divide-x divide-white/20">
              <div className="space-y-1 pt-4 lg:pt-0">
                <div className="text-3xl sm:text-4xl font-extrabold tracking-tight">150+</div>
                <div className="text-xs sm:text-sm font-medium text-red-100">Website Selesai Tepat Waktu</div>
              </div>
              <div className="space-y-1 pt-4 lg:pt-0">
                <div className="text-3xl sm:text-4xl font-extrabold tracking-tight">99.4%</div>
                <div className="text-xs sm:text-sm font-medium text-red-100">Kepuasan Klien Partner</div>
              </div>
              <div className="space-y-1 pt-4 lg:pt-0">
                <div className="text-3xl sm:text-4xl font-extrabold tracking-tight">&lt; 2 Detik</div>
                <div className="text-xs sm:text-sm font-medium text-red-100">Rata-Rata Loading Speed</div>
              </div>
              <div className="space-y-1 pt-4 lg:pt-0">
                <div className="text-3xl sm:text-4xl font-extrabold tracking-tight">24/7</div>
                <div className="text-xs sm:text-sm font-medium text-red-100">Layanan Support Teknis</div>
              </div>
            </div>
          </div>
        </ScrollReveal>
