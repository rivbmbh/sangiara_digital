...
import { Star, ChevronDown, Quote, HelpCircle } from "lucide-react";
...
export default function TestimonialsFAQ() {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Layanan SANGIARA DIGITAL sangat luar biasa! Website company profile perusahaan kami dikerjakan hanya dalam 5 hari dengan skor Google Speed 99. Omset dan kepercayaan klien langsung naik!",
      avatarBg: "bg-red-500",
    },
    {
      name: "Rina Wijaya",
      ...
      rating: 5,
      comment:
        "Toko online kami jadi jauh lebih keren dan transaksi otomatis via WhatsApp & Payment Gateway lancar tanpa kendala. Desainnya benar-benar eksklusif!",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Sangat puas dengan pengerjaan Web App SaaS klinik kami. Timnya komunikatif, profesional, dan selalu memberikan garansi teknis cepat.",
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sangat mudah! Kami membuatkan dashboard pengelola konten yang user-friendly serta menyertakan video panduan cara meng-update produk, artikel, maupun foto portofolio.",
    },
    {
                ...
                <ScrollReveal key={faq.q} delayMs={idx * 60}>
                  <div className="rounded-2xl bg-white border border-slate-200/80 overflow-hidden shadow-xs">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-5 h-5 shrink-0 text-slate-400 transition-transform duration-300 ${isOpen ? "rotate-180 text-red-600" : ""}`}
                      />
                    </button>
                    {isOpen && (
