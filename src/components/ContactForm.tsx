...
import { MessageSquare, Send, CheckCircle2, Phone, Mail, MapPin, Flame, Clock, Sparkles } from "lucide-react";
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <ScrollReveal delayMs={100}>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
                Konsultasikan Kebutuhan Website Anda Bersama <span className="gradient-fire-text">SANGIARA DIGITAL</span>
              </h2>
            </ScrollReveal>

            <ScrollReveal delayMs={200}>
              <p className="text-slate-600 text-base leading-relaxed">
                Tim profesional kami siap membantu merencanakan konsep website terbaik untuk meningkatkan omset dan citra bisnis Anda.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delayMs={300}>
              <div className="space-y-4 pt-2">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-200/80">
                  <div className="w-12 h-12 rounded-xl gradient-fire-bg text-white flex items-center justify-center shrink-0 shadow-md">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-medium">WhatsApp Direct Fast Response</div>
                    <div className="text-base font-bold text-slate-900">+62 812-3456-7890</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-200/80">
                  ...
                  <div>
                    <div className="text-xs text-slate-500 font-medium">Email Official Agency</div>
                    <div className="text-base font-bold text-slate-900">halo@sangiara.digital</div>
                  </div>
                </div>

                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-200/80">
                  <div className="w-12 h-12 rounded-xl bg-red-100 text-red-600 flex items-center justify-center shrink-0 shadow-md">
                    <Clock className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-medium">Jam Operasional Layanan</div>
                    <div className="text-base font-bold text-slate-900">Senin - Sabtu: 08.00 - 21.00 WIB</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
          ...
          <div className="lg:col-span-7">
            <ScrollReveal delayMs={200}>
              <div className="bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xl relative overflow-hidden">
                ...
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-slate-900">Kirim Pesan Proyek</h3>
                  <p className="text-xs text-slate-500 mt-1">Isi formulir di bawah ini, tim SANGIARA DIGITAL akan menghubungi Anda dalam waktu kurang dari 2 jam.</p>
                </div>

                {submitted ? (
                  <div className="p-8 bg-emerald-50 rounded-2xl border border-emerald-200 text-center space-y-4">
                    <CheckCircle2 className="w-14 h-14 text-emerald-600 mx-auto animate-bounce" />
                    <h4 className="text-xl font-bold text-emerald-900">Pesan Terkirim!</h4>
                    <p className="text-sm text-emerald-700">
                      Terima kasih <strong className="font-bold">{formData.name}</strong>. Tim SANGIARA DIGITAL akan segera membalas konsultasi Anda.
                    </p>
                    <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label className="block text-xs font-bold text-slate-700 mb-1.5">Jenis Layanan</label>
                        <select
                        ...
                        >
                          ...
                          <option value="Web App / SaaS Custom">Web App / SaaS Custom</option>
                          <option value="Redesign & Speed Up Web">Redesign & Speed Up Web</option>
                          <option value="SEO Optimization & Maintenance">SEO Optimization & Maintenance</option>
                        </select>
                      </div>
                    </div>

                    <div>
                      <label className="block text-xs font-bold text-slate-700 mb-1.5">Detail Rencana Proyek *</label>
                      <textarea
                        rows={4}
                        required
